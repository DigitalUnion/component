...
func (p *TColumnFamilyDescriptor) Read(ctx context.Context, iprot thrift.TProtocol) error {
	...
	if !issetName {
		return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("Required field ServicePath is not set"))
	}
	return nil
}
...
type THBaseService interface {
	...
	//
	// Parameters:
	//  - ServicePath: The namesapce's name
	...
	//
	// Parameters:
	//  - ServicePath: name of namespace descriptor
...
func (p *THBaseServiceClient) GetMultiple(ctx context.Context, table []byte, tgets []*TGet) (_r []*TResult_, _err error) {
	var _args62 THBaseServiceGetMultipleArgs
	_args62.Table = table
	_args62.Tgets = tgets
	var _result64 THBaseServiceGetMultipleResult
	var _meta63 thrift.ResponseMeta
	_meta63, _err = p.Client_().Call(ctx, "getMultiple", &_args62, &_result64)
...
func (p *THBaseServiceClient) Put(ctx context.Context, table []byte, tput *TPut) (_err error) {
	var _args65 THBaseServicePutArgs
	_args65.Table = table
	_args65.Tput = tput
	var _result67 THBaseServicePutResult
	var _meta66 thrift.ResponseMeta
	_meta66, _err = p.Client_().Call(ctx, "put", &_args65, &_result67)
...
func (p *THBaseServiceClient) CheckAndPut(ctx context.Context, table []byte, row []byte, family []byte, qualifier []byte, value []byte, tput *TPut) (_r bool, _err error) {
	var _args68 THBaseServiceCheckAndPutArgs
	_args68.Table = table
	_args68.Row = row
	_args68.Family = family
	_args68.Qualifier = qualifier
	_args68.Value = value
	_args68.Tput = tput
	var _result70 THBaseServiceCheckAndPutResult
	var _meta69 thrift.ResponseMeta
	_meta69, _err = p.Client_().Call(ctx, "checkAndPut", &_args68, &_result70)
...
func (p *THBaseServiceClient) PutMultiple(ctx context.Context, table []byte, tputs []*TPut) (_err error) {
	var _args71 THBaseServicePutMultipleArgs
	_args71.Table = table
	_args71.Tputs = tputs
	var _result73 THBaseServicePutMultipleResult
	var _meta72 thrift.ResponseMeta
	_meta72, _err = p.Client_().Call(ctx, "putMultiple", &_args71, &_result73)
...
func (p *THBaseServiceClient) DeleteSingle(ctx context.Context, table []byte, tdelete *TDelete) (_err error) {
	var _args74 THBaseServiceDeleteSingleArgs
	_args74.Table = table
	_args74.Tdelete = tdelete
	var _result76 THBaseServiceDeleteSingleResult
	var _meta75 thrift.ResponseMeta
	_meta75, _err = p.Client_().Call(ctx, "deleteSingle", &_args74, &_result76)
...
func (p *THBaseServiceClient) DeleteMultiple(ctx context.Context, table []byte, tdeletes []*TDelete) (_r []*TDelete, _err error) {
	var _args77 THBaseServiceDeleteMultipleArgs
	_args77.Table = table
	_args77.Tdeletes = tdeletes
	var _result79 THBaseServiceDeleteMultipleResult
	var _meta78 thrift.ResponseMeta
	_meta78, _err = p.Client_().Call(ctx, "deleteMultiple", &_args77, &_result79)
...
func (p *THBaseServiceClient) CheckAndDelete(ctx context.Context, table []byte, row []byte, family []byte, qualifier []byte, value []byte, tdelete *TDelete) (_r bool, _err error) {
	var _args80 THBaseServiceCheckAndDeleteArgs
	_args80.Table = table
	_args80.Row = row
	_args80.Family = family
	_args80.Qualifier = qualifier
	_args80.Value = value
	_args80.Tdelete = tdelete
	var _result82 THBaseServiceCheckAndDeleteResult
	var _meta81 thrift.ResponseMeta
	_meta81, _err = p.Client_().Call(ctx, "checkAndDelete", &_args80, &_result82)
...
func (p *THBaseServiceClient) Increment(ctx context.Context, table []byte, tincrement *TIncrement) (_r *TResult_, _err error) {
	var _args83 THBaseServiceIncrementArgs
	_args83.Table = table
	_args83.Tincrement = tincrement
	var _result85 THBaseServiceIncrementResult
	var _meta84 thrift.ResponseMeta
	_meta84, _err = p.Client_().Call(ctx, "increment", &_args83, &_result85)
...
func (p *THBaseServiceClient) Append(ctx context.Context, table []byte, tappend *TAppend) (_r *TResult_, _err error) {
	var _args86 THBaseServiceAppendArgs
	_args86.Table = table
	_args86.Tappend = tappend
	var _result88 THBaseServiceAppendResult
	var _meta87 thrift.ResponseMeta
	_meta87, _err = p.Client_().Call(ctx, "append", &_args86, &_result88)
...
func (p *THBaseServiceClient) OpenScanner(ctx context.Context, table []byte, tscan *TScan) (_r int32, _err error) {
	var _args89 THBaseServiceOpenScannerArgs
	_args89.Table = table
	_args89.Tscan = tscan
	var _result91 THBaseServiceOpenScannerResult
	var _meta90 thrift.ResponseMeta
	_meta90, _err = p.Client_().Call(ctx, "openScanner", &_args89, &_result91)
...
func (p *THBaseServiceClient) GetScannerRows(ctx context.Context, scannerId int32, numRows int32) (_r []*TResult_, _err error) {
	var _args92 THBaseServiceGetScannerRowsArgs
	_args92.ScannerId = scannerId
	_args92.NumRows = numRows
	var _result94 THBaseServiceGetScannerRowsResult
	var _meta93 thrift.ResponseMeta
	_meta93, _err = p.Client_().Call(ctx, "getScannerRows", &_args92, &_result94)
...
func (p *THBaseServiceClient) CloseScanner(ctx context.Context, scannerId int32) (_err error) {
	var _args95 THBaseServiceCloseScannerArgs
	_args95.ScannerId = scannerId
	var _result97 THBaseServiceCloseScannerResult
	var _meta96 thrift.ResponseMeta
	_meta96, _err = p.Client_().Call(ctx, "closeScanner", &_args95, &_result97)
...
func (p *THBaseServiceClient) MutateRow(ctx context.Context, table []byte, trowMutations *TRowMutations) (_err error) {
	var _args98 THBaseServiceMutateRowArgs
	_args98.Table = table
	_args98.TrowMutations = trowMutations
	var _result100 THBaseServiceMutateRowResult
	var _meta99 thrift.ResponseMeta
	_meta99, _err = p.Client_().Call(ctx, "mutateRow", &_args98, &_result100)
...
func (p *THBaseServiceClient) GetScannerResults(ctx context.Context, table []byte, tscan *TScan, numRows int32) (_r []*TResult_, _err error) {
	var _args101 THBaseServiceGetScannerResultsArgs
	_args101.Table = table
	_args101.Tscan = tscan
	_args101.NumRows = numRows
	var _result103 THBaseServiceGetScannerResultsResult
	var _meta102 thrift.ResponseMeta
	_meta102, _err = p.Client_().Call(ctx, "getScannerResults", &_args101, &_result103)
...
func (p *THBaseServiceClient) GetRegionLocation(ctx context.Context, table []byte, row []byte, reload bool) (_r *THRegionLocation, _err error) {
	var _args104 THBaseServiceGetRegionLocationArgs
	_args104.Table = table
	_args104.Row = row
	_args104.Reload = reload
	var _result106 THBaseServiceGetRegionLocationResult
	var _meta105 thrift.ResponseMeta
	_meta105, _err = p.Client_().Call(ctx, "getRegionLocation", &_args104, &_result106)
...
func (p *THBaseServiceClient) GetAllRegionLocations(ctx context.Context, table []byte) (_r []*THRegionLocation, _err error) {
	var _args107 THBaseServiceGetAllRegionLocationsArgs
	_args107.Table = table
	var _result109 THBaseServiceGetAllRegionLocationsResult
	var _meta108 thrift.ResponseMeta
	_meta108, _err = p.Client_().Call(ctx, "getAllRegionLocations", &_args107, &_result109)
...
func (p *THBaseServiceClient) CheckAndMutate(ctx context.Context, table []byte, row []byte, family []byte, qualifier []byte, compareOp TCompareOp, value []byte, rowMutations *TRowMutations) (_r bool, _err error) {
	var _args110 THBaseServiceCheckAndMutateArgs
	_args110.Table = table
	_args110.Row = row
	_args110.Family = family
	_args110.Qualifier = qualifier
	_args110.CompareOp = compareOp
	_args110.Value = value
	_args110.RowMutations = rowMutations
	var _result112 THBaseServiceCheckAndMutateResult
	var _meta111 thrift.ResponseMeta
	_meta111, _err = p.Client_().Call(ctx, "checkAndMutate", &_args110, &_result112)
	p.SetLastResponseMeta_(_meta111)
	if _err != nil {
		return
	}
	switch {
	case _result112.Io != nil:
		return _r, _result112.Io
	}
...
func (p *THBaseServiceClient) GetTableDescriptor(ctx context.Context, table *TTableName) (_r *TTableDescriptor, _err error) {
	var _args113 THBaseServiceGetTableDescriptorArgs
	_args113.Table = table
	var _result115 THBaseServiceGetTableDescriptorResult
	var _meta114 thrift.ResponseMeta
	_meta114, _err = p.Client_().Call(ctx, "getTableDescriptor", &_args113, &_result115)
...
func (p *THBaseServiceClient) GetTableDescriptors(ctx context.Context, tables []*TTableName) (_r []*TTableDescriptor, _err error) {
	var _args116 THBaseServiceGetTableDescriptorsArgs
	_args116.Tables = tables
	var _result118 THBaseServiceGetTableDescriptorsResult
	var _meta117 thrift.ResponseMeta
	_meta117, _err = p.Client_().Call(ctx, "getTableDescriptors", &_args116, &_result118)
	p.SetLastResponseMeta_(_meta117)
	if _err != nil {
		return
	}
	switch {
	case _result118.Io != nil:
		return _r, _result118.Io
	}
...
func (p *THBaseServiceClient) TableExists(ctx context.Context, tableName *TTableName) (_r bool, _err error) {
	var _args119 THBaseServiceTableExistsArgs
	_args119.TableName = tableName
	var _result121 THBaseServiceTableExistsResult
	var _meta120 thrift.ResponseMeta
	_meta120, _err = p.Client_().Call(ctx, "tableExists", &_args119, &_result121)
...
func (p *THBaseServiceClient) GetTableDescriptorsByPattern(ctx context.Context, regex string, includeSysTables bool) (_r []*TTableDescriptor, _err error) {
	var _args122 THBaseServiceGetTableDescriptorsByPatternArgs
	_args122.Regex = regex
	_args122.IncludeSysTables = includeSysTables
	var _result124 THBaseServiceGetTableDescriptorsByPatternResult
	var _meta123 thrift.ResponseMeta
	_meta123, _err = p.Client_().Call(ctx, "getTableDescriptorsByPattern", &_args122, &_result124)
	p.SetLastResponseMeta_(_meta123)
	if _err != nil {
		return
	}
	switch {
	case _result124.Io != nil:
		return _r, _result124.Io
	}
...
func (p *THBaseServiceClient) GetTableDescriptorsByNamespace(ctx context.Context, name string) (_r []*TTableDescriptor, _err error) {
	var _args125 THBaseServiceGetTableDescriptorsByNamespaceArgs
	_args125.Name = name
	var _result127 THBaseServiceGetTableDescriptorsByNamespaceResult
	var _meta126 thrift.ResponseMeta
	_meta126, _err = p.Client_().Call(ctx, "getTableDescriptorsByNamespace", &_args125, &_result127)
	p.SetLastResponseMeta_(_meta126)
	if _err != nil {
		return
	}
	switch {
	case _result127.Io != nil:
		return _r, _result127.Io
	}
...
func (p *THBaseServiceClient) GetTableNamesByPattern(ctx context.Context, regex string, includeSysTables bool) (_r []*TTableName, _err error) {
	var _args128 THBaseServiceGetTableNamesByPatternArgs
	_args128.Regex = regex
	_args128.IncludeSysTables = includeSysTables
	var _result130 THBaseServiceGetTableNamesByPatternResult
	var _meta129 thrift.ResponseMeta
	_meta129, _err = p.Client_().Call(ctx, "getTableNamesByPattern", &_args128, &_result130)
	p.SetLastResponseMeta_(_meta129)
	if _err != nil {
		return
	}
	switch {
	case _result130.Io != nil:
		return _r, _result130.Io
	}
...
func (p *THBaseServiceClient) GetTableNamesByNamespace(ctx context.Context, name string) (_r []*TTableName, _err error) {
	var _args131 THBaseServiceGetTableNamesByNamespaceArgs
	_args131.Name = name
	var _result133 THBaseServiceGetTableNamesByNamespaceResult
	var _meta132 thrift.ResponseMeta
	_meta132, _err = p.Client_().Call(ctx, "getTableNamesByNamespace", &_args131, &_result133)
	p.SetLastResponseMeta_(_meta132)
	if _err != nil {
		return
	}
	switch {
	case _result133.Io != nil:
		return _r, _result133.Io
	}
...
func (p *THBaseServiceClient) CreateTable(ctx context.Context, desc *TTableDescriptor, splitKeys [][]byte) (_err error) {
	var _args134 THBaseServiceCreateTableArgs
	_args134.Desc = desc
	_args134.SplitKeys = splitKeys
	var _result136 THBaseServiceCreateTableResult
	var _meta135 thrift.ResponseMeta
	_meta135, _err = p.Client_().Call(ctx, "createTable", &_args134, &_result136)
	p.SetLastResponseMeta_(_meta135)
	if _err != nil {
		return
	}
	switch {
	case _result136.Io != nil:
		return _result136.Io
	}
...
func (p *THBaseServiceClient) DeleteTable(ctx context.Context, tableName *TTableName) (_err error) {
	var _args137 THBaseServiceDeleteTableArgs
	_args137.TableName = tableName
	var _result139 THBaseServiceDeleteTableResult
	var _meta138 thrift.ResponseMeta
	_meta138, _err = p.Client_().Call(ctx, "deleteTable", &_args137, &_result139)
	p.SetLastResponseMeta_(_meta138)
	if _err != nil {
		return
	}
	switch {
	case _result139.Io != nil:
		return _result139.Io
	}
...
func (p *THBaseServiceClient) TruncateTable(ctx context.Context, tableName *TTableName, preserveSplits bool) (_err error) {
	var _args140 THBaseServiceTruncateTableArgs
	_args140.TableName = tableName
	_args140.PreserveSplits = preserveSplits
	var _result142 THBaseServiceTruncateTableResult
	var _meta141 thrift.ResponseMeta
	_meta141, _err = p.Client_().Call(ctx, "truncateTable", &_args140, &_result142)
	p.SetLastResponseMeta_(_meta141)
	if _err != nil {
		return
	}
	switch {
	case _result142.Io != nil:
		return _result142.Io
	}
...
func (p *THBaseServiceClient) EnableTable(ctx context.Context, tableName *TTableName) (_err error) {
	var _args143 THBaseServiceEnableTableArgs
	_args143.TableName = tableName
	var _result145 THBaseServiceEnableTableResult
	var _meta144 thrift.ResponseMeta
	_meta144, _err = p.Client_().Call(ctx, "enableTable", &_args143, &_result145)
	p.SetLastResponseMeta_(_meta144)
	if _err != nil {
		return
	}
	switch {
	case _result145.Io != nil:
		return _result145.Io
	}
...
func (p *THBaseServiceClient) DisableTable(ctx context.Context, tableName *TTableName) (_err error) {
	var _args146 THBaseServiceDisableTableArgs
	_args146.TableName = tableName
	var _result148 THBaseServiceDisableTableResult
	var _meta147 thrift.ResponseMeta
	_meta147, _err = p.Client_().Call(ctx, "disableTable", &_args146, &_result148)
	p.SetLastResponseMeta_(_meta147)
	if _err != nil {
		return
	}
	switch {
	case _result148.Io != nil:
		return _result148.Io
	}
...
func (p *THBaseServiceClient) IsTableEnabled(ctx context.Context, tableName *TTableName) (_r bool, _err error) {
	var _args149 THBaseServiceIsTableEnabledArgs
	_args149.TableName = tableName
	var _result151 THBaseServiceIsTableEnabledResult
	var _meta150 thrift.ResponseMeta
	_meta150, _err = p.Client_().Call(ctx, "isTableEnabled", &_args149, &_result151)
	p.SetLastResponseMeta_(_meta150)
	if _err != nil {
		return
	}
	switch {
	case _result151.Io != nil:
		return _r, _result151.Io
	}
...
func (p *THBaseServiceClient) IsTableDisabled(ctx context.Context, tableName *TTableName) (_r bool, _err error) {
	var _args152 THBaseServiceIsTableDisabledArgs
	_args152.TableName = tableName
	var _result154 THBaseServiceIsTableDisabledResult
	var _meta153 thrift.ResponseMeta
	_meta153, _err = p.Client_().Call(ctx, "isTableDisabled", &_args152, &_result154)
	p.SetLastResponseMeta_(_meta153)
	if _err != nil {
		return
	}
	switch {
	case _result154.Io != nil:
		return _r, _result154.Io
	}
...
func (p *THBaseServiceClient) IsTableAvailable(ctx context.Context, tableName *TTableName) (_r bool, _err error) {
	var _args155 THBaseServiceIsTableAvailableArgs
	_args155.TableName = tableName
	var _result157 THBaseServiceIsTableAvailableResult
	var _meta156 thrift.ResponseMeta
	_meta156, _err = p.Client_().Call(ctx, "isTableAvailable", &_args155, &_result157)
	p.SetLastResponseMeta_(_meta156)
	if _err != nil {
		return
	}
	switch {
	case _result157.Io != nil:
		return _r, _result157.Io
	}
...
func (p *THBaseServiceClient) IsTableAvailableWithSplit(ctx context.Context, tableName *TTableName, splitKeys [][]byte) (_r bool, _err error) {
	var _args158 THBaseServiceIsTableAvailableWithSplitArgs
	_args158.TableName = tableName
	_args158.SplitKeys = splitKeys
	var _result160 THBaseServiceIsTableAvailableWithSplitResult
	var _meta159 thrift.ResponseMeta
	_meta159, _err = p.Client_().Call(ctx, "isTableAvailableWithSplit", &_args158, &_result160)
	p.SetLastResponseMeta_(_meta159)
	if _err != nil {
		return
	}
	switch {
	case _result160.Io != nil:
		return _r, _result160.Io
	}
...
func (p *THBaseServiceClient) AddColumnFamily(ctx context.Context, tableName *TTableName, column *TColumnFamilyDescriptor) (_err error) {
	var _args161 THBaseServiceAddColumnFamilyArgs
	_args161.TableName = tableName
	_args161.Column = column
	var _result163 THBaseServiceAddColumnFamilyResult
	var _meta162 thrift.ResponseMeta
	_meta162, _err = p.Client_().Call(ctx, "addColumnFamily", &_args161, &_result163)
	p.SetLastResponseMeta_(_meta162)
	if _err != nil {
		return
	}
	switch {
	case _result163.Io != nil:
		return _result163.Io
	}
...
func (p *THBaseServiceClient) DeleteColumnFamily(ctx context.Context, tableName *TTableName, column []byte) (_err error) {
	var _args164 THBaseServiceDeleteColumnFamilyArgs
	_args164.TableName = tableName
	_args164.Column = column
	var _result166 THBaseServiceDeleteColumnFamilyResult
	var _meta165 thrift.ResponseMeta
	_meta165, _err = p.Client_().Call(ctx, "deleteColumnFamily", &_args164, &_result166)
	p.SetLastResponseMeta_(_meta165)
	if _err != nil {
		return
	}
	switch {
	case _result166.Io != nil:
		return _result166.Io
	}
...
func (p *THBaseServiceClient) ModifyColumnFamily(ctx context.Context, tableName *TTableName, column *TColumnFamilyDescriptor) (_err error) {
	var _args167 THBaseServiceModifyColumnFamilyArgs
	_args167.TableName = tableName
	_args167.Column = column
	var _result169 THBaseServiceModifyColumnFamilyResult
	var _meta168 thrift.ResponseMeta
	_meta168, _err = p.Client_().Call(ctx, "modifyColumnFamily", &_args167, &_result169)
	p.SetLastResponseMeta_(_meta168)
	if _err != nil {
		return
	}
	switch {
	case _result169.Io != nil:
		return _result169.Io
	}
...
func (p *THBaseServiceClient) ModifyTable(ctx context.Context, desc *TTableDescriptor) (_err error) {
	var _args170 THBaseServiceModifyTableArgs
	_args170.Desc = desc
	var _result172 THBaseServiceModifyTableResult
	var _meta171 thrift.ResponseMeta
	_meta171, _err = p.Client_().Call(ctx, "modifyTable", &_args170, &_result172)
	p.SetLastResponseMeta_(_meta171)
	if _err != nil {
		return
	}
	switch {
	case _result172.Io != nil:
		return _result172.Io
	}
...
func (p *THBaseServiceClient) CreateNamespace(ctx context.Context, namespaceDesc *TNamespaceDescriptor) (_err error) {
	var _args173 THBaseServiceCreateNamespaceArgs
	_args173.NamespaceDesc = namespaceDesc
	var _result175 THBaseServiceCreateNamespaceResult
	var _meta174 thrift.ResponseMeta
	_meta174, _err = p.Client_().Call(ctx, "createNamespace", &_args173, &_result175)
	p.SetLastResponseMeta_(_meta174)
	if _err != nil {
		return
	}
	switch {
	case _result175.Io != nil:
		return _result175.Io
	}
...
func (p *THBaseServiceClient) ModifyNamespace(ctx context.Context, namespaceDesc *TNamespaceDescriptor) (_err error) {
	var _args176 THBaseServiceModifyNamespaceArgs
	_args176.NamespaceDesc = namespaceDesc
	var _result178 THBaseServiceModifyNamespaceResult
	var _meta177 thrift.ResponseMeta
	_meta177, _err = p.Client_().Call(ctx, "modifyNamespace", &_args176, &_result178)
	p.SetLastResponseMeta_(_meta177)
	if _err != nil {
		return
	}
	switch {
	case _result178.Io != nil:
		return _result178.Io
	}
...
func (p *THBaseServiceClient) DeleteNamespace(ctx context.Context, name string) (_err error) {
	var _args179 THBaseServiceDeleteNamespaceArgs
	_args179.Name = name
	var _result181 THBaseServiceDeleteNamespaceResult
	var _meta180 thrift.ResponseMeta
	_meta180, _err = p.Client_().Call(ctx, "deleteNamespace", &_args179, &_result181)
	p.SetLastResponseMeta_(_meta180)
	if _err != nil {
		return
	}
	switch {
	case _result181.Io != nil:
		return _result181.Io
	}
...
func (p *THBaseServiceClient) GetNamespaceDescriptor(ctx context.Context, name string) (_r *TNamespaceDescriptor, _err error) {
	var _args182 THBaseServiceGetNamespaceDescriptorArgs
	_args182.Name = name
	var _result184 THBaseServiceGetNamespaceDescriptorResult
	var _meta183 thrift.ResponseMeta
	_meta183, _err = p.Client_().Call(ctx, "getNamespaceDescriptor", &_args182, &_result184)
	p.SetLastResponseMeta_(_meta183)
	if _err != nil {
		return
	}
	switch {
	case _result184.Io != nil:
		return _r, _result184.Io
	}
...
func (p *THBaseServiceClient) ListNamespaceDescriptors(ctx context.Context) (_r []*TNamespaceDescriptor, _err error) {
	var _args185 THBaseServiceListNamespaceDescriptorsArgs
	var _result187 THBaseServiceListNamespaceDescriptorsResult
	var _meta186 thrift.ResponseMeta
	_meta186, _err = p.Client_().Call(ctx, "listNamespaceDescriptors", &_args185, &_result187)
	p.SetLastResponseMeta_(_meta186)
	if _err != nil {
		return
	}
	switch {
	case _result187.Io != nil:
		return _r, _result187.Io
	}
...
func NewTHBaseServiceProcessor(handler THBaseService) *THBaseServiceProcessor {
	...
	self188 := &THBaseServiceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self188.processorMap["exists"] = &tHBaseServiceProcessorExists{handler: handler}
	self188.processorMap["existsAll"] = &tHBaseServiceProcessorExistsAll{handler: handler}
	self188.processorMap["get"] = &tHBaseServiceProcessorGet{handler: handler}
	self188.processorMap["getMultiple"] = &tHBaseServiceProcessorGetMultiple{handler: handler}
	self188.processorMap["put"] = &tHBaseServiceProcessorPut{handler: handler}
	self188.processorMap["checkAndPut"] = &tHBaseServiceProcessorCheckAndPut{handler: handler}
	self188.processorMap["putMultiple"] = &tHBaseServiceProcessorPutMultiple{handler: handler}
	self188.processorMap["deleteSingle"] = &tHBaseServiceProcessorDeleteSingle{handler: handler}
	self188.processorMap["deleteMultiple"] = &tHBaseServiceProcessorDeleteMultiple{handler: handler}
	self188.processorMap["checkAndDelete"] = &tHBaseServiceProcessorCheckAndDelete{handler: handler}
	self188.processorMap["increment"] = &tHBaseServiceProcessorIncrement{handler: handler}
	self188.processorMap["append"] = &tHBaseServiceProcessorAppend{handler: handler}
	self188.processorMap["openScanner"] = &tHBaseServiceProcessorOpenScanner{handler: handler}
	self188.processorMap["getScannerRows"] = &tHBaseServiceProcessorGetScannerRows{handler: handler}
	self188.processorMap["closeScanner"] = &tHBaseServiceProcessorCloseScanner{handler: handler}
	self188.processorMap["mutateRow"] = &tHBaseServiceProcessorMutateRow{handler: handler}
	self188.processorMap["getScannerResults"] = &tHBaseServiceProcessorGetScannerResults{handler: handler}
	self188.processorMap["getRegionLocation"] = &tHBaseServiceProcessorGetRegionLocation{handler: handler}
	self188.processorMap["getAllRegionLocations"] = &tHBaseServiceProcessorGetAllRegionLocations{handler: handler}
	self188.processorMap["checkAndMutate"] = &tHBaseServiceProcessorCheckAndMutate{handler: handler}
	self188.processorMap["getTableDescriptor"] = &tHBaseServiceProcessorGetTableDescriptor{handler: handler}
	self188.processorMap["getTableDescriptors"] = &tHBaseServiceProcessorGetTableDescriptors{handler: handler}
	self188.processorMap["tableExists"] = &tHBaseServiceProcessorTableExists{handler: handler}
	self188.processorMap["getTableDescriptorsByPattern"] = &tHBaseServiceProcessorGetTableDescriptorsByPattern{handler: handler}
	self188.processorMap["getTableDescriptorsByNamespace"] = &tHBaseServiceProcessorGetTableDescriptorsByNamespace{handler: handler}
	self188.processorMap["getTableNamesByPattern"] = &tHBaseServiceProcessorGetTableNamesByPattern{handler: handler}
	self188.processorMap["getTableNamesByNamespace"] = &tHBaseServiceProcessorGetTableNamesByNamespace{handler: handler}
	self188.processorMap["createTable"] = &tHBaseServiceProcessorCreateTable{handler: handler}
	self188.processorMap["deleteTable"] = &tHBaseServiceProcessorDeleteTable{handler: handler}
	self188.processorMap["truncateTable"] = &tHBaseServiceProcessorTruncateTable{handler: handler}
	self188.processorMap["enableTable"] = &tHBaseServiceProcessorEnableTable{handler: handler}
	self188.processorMap["disableTable"] = &tHBaseServiceProcessorDisableTable{handler: handler}
	self188.processorMap["isTableEnabled"] = &tHBaseServiceProcessorIsTableEnabled{handler: handler}
	self188.processorMap["isTableDisabled"] = &tHBaseServiceProcessorIsTableDisabled{handler: handler}
	self188.processorMap["isTableAvailable"] = &tHBaseServiceProcessorIsTableAvailable{handler: handler}
	self188.processorMap["isTableAvailableWithSplit"] = &tHBaseServiceProcessorIsTableAvailableWithSplit{handler: handler}
	self188.processorMap["addColumnFamily"] = &tHBaseServiceProcessorAddColumnFamily{handler: handler}
	self188.processorMap["deleteColumnFamily"] = &tHBaseServiceProcessorDeleteColumnFamily{handler: handler}
	self188.processorMap["modifyColumnFamily"] = &tHBaseServiceProcessorModifyColumnFamily{handler: handler}
	self188.processorMap["modifyTable"] = &tHBaseServiceProcessorModifyTable{handler: handler}
	self188.processorMap["createNamespace"] = &tHBaseServiceProcessorCreateNamespace{handler: handler}
	self188.processorMap["modifyNamespace"] = &tHBaseServiceProcessorModifyNamespace{handler: handler}
	self188.processorMap["deleteNamespace"] = &tHBaseServiceProcessorDeleteNamespace{handler: handler}
	self188.processorMap["getNamespaceDescriptor"] = &tHBaseServiceProcessorGetNamespaceDescriptor{handler: handler}
	self188.processorMap["listNamespaceDescriptors"] = &tHBaseServiceProcessorListNamespaceDescriptors{handler: handler}
	return self188
}
...
func (p *THBaseServiceExistsAllArgs) ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Tgets = append(p.Tgets, _elem190)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *THBaseServiceGetMultipleArgs) ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Tgets = append(p.Tgets, _elem192)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *THBaseServicePutMultipleArgs) ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Tputs = append(p.Tputs, _elem194)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *THBaseServiceDeleteMultipleArgs) ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Tdeletes = append(p.Tdeletes, _elem195)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *THBaseServiceGetScannerRowsResult) ReadField0(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		_elem197 := &TResult_{}
		if err := _elem197.Read(ctx, iprot); err != nil {
...
func (p *THBaseServiceGetScannerResultsResult) ReadField0(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Success = append(p.Success, _elem198)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *THBaseServiceGetTableDescriptorsArgs) ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Tables = append(p.Tables, _elem200)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *THBaseServiceCreateTableArgs) ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.SplitKeys = append(p.SplitKeys, _elem206)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *THBaseServiceIsTableAvailableWithSplitArgs) ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.SplitKeys = append(p.SplitKeys, _elem207)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
