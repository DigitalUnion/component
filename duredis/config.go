...
type RedisConfig struct {
	// host:port address.
	Host     string `json:"host" yaml:"host" toml:"host" ini:",,allowshadow"`
	...
	MaxConnAge int64 `json:"max_conn_age" yaml:"max_conn_age" toml:"max_conn_age"`
	// Dial timeout for establishing new connections.
	// Default is 5 seconds.
	DialTimeout int64 `json:"dial_timeout" yaml:"dial_timeout" toml:"dial_timeout"`
	...
	PoolTimeout int64 `json:"pool_timeout" yaml:"pool_timeout" toml:"pool_timeout"`
